...
const EditTraining = () => {
  ...
  const { getTraining, updateTraining, subjects } = useLearningUnits();
    ...
    <div className="max-w-2xl mx-auto">
      <div className="mb-6">
        ...
        >
          ...
          Zurück zu {training.title}
        </button>
        <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Training bearbeiten</h2>
      </div>
